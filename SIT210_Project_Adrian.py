...
PARTICLE_USERNAME = "enter_your_own_credential"
PARTICLE_PASSWORD = "enter_your_own_credential"
PARTICLE_DEVICE_ID = "enter_your_own_credential"

# Create a new Particle API client
particle = Particle(pdgid=123, pdg_name='enter_your_own_credential')
